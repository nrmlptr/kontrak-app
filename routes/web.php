...
Route::middleware('auth')->group(
    function () {
        ...
        // VIEW detail grafik KONTRAK BY JENIS KONTRAK
        Route::get('/contracts/jenis_kontrak/{jenisKontrak}', [HomeController::class, 'viewByJenisKontrak'])->name('viewByJenisKontrak');

        // VIEW detail grafik Kontrak per vendor
        Route::get('/contracts/vendor/{vendor}', [HomeController::class, 'viewByVendor'])->name('viewByVendor');
        //===================================================================================================================================================
        ...
        // ===================================================================================================================================================
        // konsep after create kontrak dan lampiran
        // preview Kontrak
        Route::get('/preview-kontrak/{id}', [KontrakController::class, 'previewKontrak'])->name('previewKontrak');
        // ===================================================================================================================================================

        // EDIT KONSEP KONTRAK =================================================================================
        Route::get('/editKonsepKontrak/{id}', [KontrakController::class, 'editKonsep'])
            ->name('editKonsep');
        ...
        Route::post('/send-concept/{id}', [KontrakController::class, 'kirimKonsepKontrak'])
            ->name('kirimKonsepKontrak');
        ...
        // routes/web.php
        Route::get('/convert-pdf', [PDFConvertController::class, 'convertPDF']);
