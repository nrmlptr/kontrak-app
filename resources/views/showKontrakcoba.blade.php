                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="content">
                                    ...
                                    <ol>
                                       <li>
                                        PIHAK KEDUA dengan ini berjanji dan mengikatkan diri untuk Jual {{  $lampiran2->perihal }}, yang
kemudian dalam Perjanjian ini akan disebut dengan “barang” kepada PIHAK KESATU, demikian
juga PIHAK KESATU dengan ini telah setuju dan mengikatkan diri untuk membeli barang
tersebut dari PIHAK KEDUA, yang pelaksanaannya akan dituangkan di dalam Surat Order
Pembelian (SOP) Nomor : {{  $lampiran2->nomor_sop }} tanggal {{ tanggal_indonesia($lampiran2->tanggal_sop) }}.

                                       </li>
                                       <li>
                                        Lingkup Perjanjian sebagaimana dimaksud Pasal 3 Perjanjian ini merupakan bagian yang tidak
terpisahkan dari Perjanjian ini.
                                ...
                                <div class="content">
                                    ...
                                    <span style="text-align: center;"><b>SPESIFIKASI TEKNIS</b></span>
                                        ...
                                        <img src="{{ Storage::url($l->gambar) }}" alt="{{ Storage::url($l->gambar) }}" style="margin-top:20px;margin-bottom:20px;">
                                        @endforeach
                                ...
                                <div class="content">
                                    ...
                                    <ol>
                                        ...
                                        <li>
                                            ...
                                            Nomor : {{ @$lampiran4[0]->nomor_sop }} tanggal {{ tanggal_indonesia(@$lampiran4[0]->tanggal_sop) }} yang diterbitkan oleh PIHAK KESATU
                                            {{-- yaitu
                                            secara bertahap sampai dengan tanggal 02 Mei 2024. --}}

                                        </li>
                                        @endif
                                       
                                       <li>
                                       Penyerahan barang dilakukan langsung ke gudang umum PIHAK KESATU di Karawang.
                                       </li>
                                       <li>
                                       Terhadap setiap Barang yang diserahkan oleh PIHAK KEDUA dan telah dinyatakan baik sesuai
dengan hasil pemeriksaan maka PIHAK KESATU akan menyatakan menerima dengan
membuat Surat Penerimaan Barang (SPB).
                                ...
                                <div class="content">
                                    ...
                                    <ol>
                                        ...
                                        dengan total harga keseluruhan sebesar {{ @formatRupiah($data->total_keseluruhan) }} ({{ terbilang($data->total_keseluruhan) }} rupiah)  sudah termasuk Pajak Pertambahan Nilai
(PPN).
                                        </li>
                                        @else
                                        <li>
                                            Harga satuan barang {{ formatRupiah(@$lampiran5[0]->harga_awal) }} per lembar dengan total harga keseluruhan sebesar
{{ @formatRupiah($data->total_keseluruhan) }} ({{ terbilang($data->total_keseluruhan) }} rupiah) sudah termasuk Pajak Pertambahan Nilai (PPN).

                                        </li>
                                        @endif
                                       
                                       <li>
                                        Harga barang dimaksud butir (1) Lampiran V ini adalah franko gudang umum PIHAK KESATU
Karawang.
                                       </li>
                                       <li>
                                       Harga dimaksud pada butir (1) Lampiran V ini terdiri dari komponen-komponen harga satuan yang
merupakan harga tetap dan tidak berubah oleh sebab apapun sampai dengan selesainya
pelaksanaan jual beli dimaksud Pasal 12 Perjanjian ini.
                                ...
                                <div class="content">
                                    ...
                                    <ol>
                                       <li>
                                        Pembayaran dari PIHAK KESATU kepada PIHAK KEDUA dilakukan setelah barang diserahkan
seluruhnya oleh PIHAK KEDUA kepada PIHAK KESATU yang dinyatakan dengan dibuatkannya
Surat Penerimaan Barang (SPB) oleh PIHAK KESATU, yang mana Surat Penerimaan Barang
(SPB) tersebut kemudian akan melengkapi perangkat (dokumen) penagihan seperti dimaksud
butir (3) Lampiran VI ini .

                                       </li>
                                       <li>
                                         Apabila ada denda terhadap PIHAK KEDUA di dalam melaksanakan jual beli dimaksud Pasal 15
Perjanjian ini, maka denda tersebut oleh PIHAK KESATU dapat langsung dibebankan pada saat
                                           ...
                                           {{-- bertahap --}}
                                            ...
                                            <ol>
                                                ...
                                                @if ($data->jenis_kontrak=='1')
                                                        <li>. Copy Jaminan Pelaksanaan dan Surat keabsahan Jaminan (Jaminan Pelaksanaan) yang
                                                telah distempel "Verified Dep. Pengadaan Perum Peruri".
                                                </li>
                                            
                                                @endif
                                            <li>Copy Surat Order Pembelian Nomor : PNP244100007199 tanggal 10 Januari 2024.</li>
