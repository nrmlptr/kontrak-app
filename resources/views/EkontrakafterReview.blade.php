            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('viewRevisi', ['id' => $data->id])  }}">Back</a></li>
                        <li class="breadcrumb-item active">Perbaiki Kontrak</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card card-primary w-100">
                <div class="card-header">
                    <h3 class="card-title mr-3">Perbarui Kontrak</h3>
                            ...
                            <div class="accordion">
                                <div class="card" id="kontrak">
                                    ...
                                    <div id="collapseKontrak" class="collapse" aria-labelledby="headingKontrak" data-parent="#accordion">
                                        <div class="card-body">
                                            <form id="formAfterRevisiKontrak" action="{{ route('submitUpdateKontrak', ['id' => $data->id]) }}" method="POST">
                                                @csrf
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $('#formAfterRevisiKontrak').on('submit', function(e) {
            ...
            $.ajax({
                method: "POST",
                url: "{{ route('updateAfterReviewKontrak', ['id' => $data->id]) }}",
                data: formData,
                beforeSend: function(){
