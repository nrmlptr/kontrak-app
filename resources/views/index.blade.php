...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <a href="{{ route('admin.user.createUser') }}" class="btn btn-primary mb-3">Add User</a>
                    <div class="card">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $d->email }}</td>
                                        <td>
                                            <a href="{{ route('admin.user.editUser', ['id' => $d->id]) }}" class="btn btn-warning"><i class="fas fa-pen"></i>Edit</a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    <form action="{{ route('admin.user.deleteUser',['id' => $d->id]) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
