...
<div class="row">
    <form id="inputLampiran4">
        ...
        <div class=" card-footer">
            <button type="button" class="btn btn-block btn-secondary btn-lg" onclick="submit_Lampiran4()">Input</button>
        </div>
    </form>
</div>
            ...
            if (dataBarang) {
                ...
                dataBarang.forEach(function(row) {
                    ...
                    <div class="form-group col-4">
                        ...
                        <input type="text" name="nama_barang[]" class="form-control" value="${escapeHtml(row.material_name)}" id="nmbaranglampiran4" required readonly>
                    </div>
                    <div class="form-group col-1">
