            ...
            if (dataBarang) {
                ...
                dataBarang.forEach(function(row) {
                    ...
                    <label for="inputNOSPPB">No.SPPB</label>
                        <input type="text" name="no_sppb[]" class="form-control" id="nosppblampiran3" value="${row.purchase_requisition_number}" readonly>
                    </div>
                    ...
                    <div class="form-group col-1">
                        ...
                        <input type="text" name="satuan[]" class="form-control" id="satuanbrglampiran3" value="${row.purchase_order_unit_of_measure}" readonly>
                    </div>
                    <div class="form-group col-12">
