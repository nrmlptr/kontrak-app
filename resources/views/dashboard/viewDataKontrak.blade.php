                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">List Data Kontrak</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            ...
                            <a href="{{ route('KontrakList') }}" class="btn btn-warning mb-2" title="Refresh Data"><i class="fas fa-sync-alt"></i></a>
                            <div class="collapse" id="collapseExample">
                                <form action="{{ route('KontrakList') }}" method="GET">
                                @csrf
                                    <div class="row">
