                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Kontrak Berdasarkan Jenis Kontrak</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"><b>Kontrak dengan Jenis Kontrak : </b>
                                    @if($jenisKontrakInDB == 1)
                            ...
                            @if($contracts->isEmpty())
                                <div class="mt-3">
                                    <h4 style="text-align: center; color: red;">Tidak Ada Kontrak untuk Jenis Kontrak Ini.</h4>
                                </div>
                            @else
                                <div class="card-body">
                                    <table id="kontrakJenisdatatable" class="table table-bordered table-striped">
                                        <thead align="center">
                                            <tr>
                                                <th>No</th>
                                                <th>Nomor Kontrak</th>
...
@push('scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#kontrakJenisdatatable').DataTable({
                "paging": true,
                "lengthChange": true,
                "pageLength": 5,
                ...
                buttons: [
                    {
                        extend: 'excel',
                        filename: 'Data_Kontrak_by_Jenis_Kontrak', // untuk nama filenya
                        title: 'Data Kontrak | Jenis Kontrak', //untuk di header nya
                        exportOptions: {
