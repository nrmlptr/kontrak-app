                ...
                <div class="row mb-2">
                    <div class="col-sm-12">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Kontrak Berdasarkan Vendor</li>
                        </ol>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"><b>Kontrak Berdasarkan Vendor : </b> <span class="badge badge-info">{{ $vendor }}</span></h3>
                            </div>
                            <!-- /.card-header -->
                            @if($contracts->isEmpty())
                                <div class="mt-3">
                                    <h4 style="text-align: center; color: red;">Tidak ada kontrak untuk vendor ini.</h4>
                                </div>
                            @else
                                <div class="card-body">
                                    <table id="viewByVendordatatable" class="table table-bordered table-striped">
                                        <thead align="center">
                                            <tr>
                                                <th>No</th>
                                                <th>Nomor Kontrak</th>
...
@push('scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            $('#viewByVendordatatable').DataTable({
                "paging": true,
                "lengthChange": true,
                "pageLength": 5,
                ...
                buttons: [
                    {
                        extend: 'excel',
                        filename: 'Data_Kontrak_by_Vendor', // untuk nama filenya
                        title: 'Data Kontrak | Nama Vendor', //untuk di header nya
                        exportOptions: {
